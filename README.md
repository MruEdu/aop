...
중고등용·성인용은 같은 네 축·같은 본문항입니다. 본문항(채점용) 화면 번호는 1–28이고, 채점·연구 저장은 내부 원번호를 씁니다. 해석요강에는 본문항 화면 번호만 적습니다. 학교 장면 또는 업무 장면의 말만 바꿉니다. 연구 파일은 `edition`(univ / school / adult)으로 나눕니다.

2026-09: 본문항 외에 연구 문항(개인 패러다임) 25개가 블라인드로 추가되어 총 53문항입니다. 해석은 네 축만 유지하며, 연구 문항은 CSV(answers)에만 보관됩니다.
...
플랫폼을 먼저 돌린 뒤 방법 절에 실시 URL, 22문항 4요인, 주의·허위, 문항평균, 1판임을 적습니다.
