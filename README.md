...
전 판본이 총 37문항(1–37번) 고정 인덱스 체계입니다. 1–28번은 네 축(IE/SA/WD/IO) 채점 문항이고, 29–33번은 쿤(개인 패러다임) 연구 문항, 34–37번은 점검(주의/허위) 문항으로 **채점·해석에서 제외**되며 DB/CSV(answers)에만 원점수(1–6)로 저장됩니다. 문항 순서 무작위 셔플은 사용하지 않습니다.
...
플랫폼을 먼저 돌린 뒤 방법 절에 실시 URL, 37문항(채점 28 + 연구 5 + 점검 4), 문항평균(1–6점), 1판임을 적습니다.
