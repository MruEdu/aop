import { DOCS } from "./docs.js?v=20260916i";
import { profileLines, resultPreface, summaryInterpret } from "./interpret.js?v=20260916i";
import {
  GENDERS,
  PUBLIC_CODE,
  REGIONS,
...
import { store, usingCloud } from "./storage.js?v=20260916i";
