import { SCALE_ORDER, SCALES } from "./items.js?v=20260916zd";
import { band, bandLabel } from "./scoring.js?v=20260916zd";
...
function axisCopy(edition) {
  ...
  return {
    ...
    wd: {
      high: "비판, 분량, 실패 앞에서 자신감이 뚝 떨어져 손을 놓고 싶어질 수 있습니다. 그럴수록 AI나 남에게 그냥 맡겨버리고 싶은 유혹이 커집니다. 먼저 부담 신호를 줄이는 쪽으로 조율하면 됩니다.",
      mid: "가끔 마음이 얼어붙거나 맡기고 싶어질 수 있습니다. 마감과 피드백 장면을 점검하면 됩니다.",
      low: "부담이 커져도 비교적 버티는 편입니다. 다만 오래 달리면 소진될 수 있으니 회복 루틴을 같이 보면 좋습니다.",
    },
    io: {
