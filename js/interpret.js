import { SCALE_ORDER, SCALES } from "./items.js?v=20260917m";
import { band, bandLabel } from "./scoring.js?v=20260917m";
...
function axisCopy(edition) {
  ...
  return {
    ...
    wd: {
      high: "분량·마감·피드백이 겹치는 장면에서는 마음의 여유가 빨리 줄어들어, 막막해지거나 ‘그냥 맡기고 싶다’는 생각이 올라올 수 있습니다.",
      mid: "대체로는 괜찮지만, 특정 장면에서는 마음이 얼어붙거나 맡기고 싶어질 수 있습니다. (마감·피드백·분량이 겹칠 때 특히 그렇습니다.)",
      low: "할 일이 많아도 주도적으로 정리하고 해쳐 나가는 편입니다. 상황이 바뀌어도 자기 페이스를 다시 잡는 힘이 있을 수 있어요.",
    },
    io: {
